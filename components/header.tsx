        ...
        <header id="header" className={styles.header}>
        {
            ...
            <nav className={styles["nav"]}>
                <div className={styles["title-bar"]}>
                    ...
                    <div className={styles["title-bar-element"]}>
                        <Link className={styles["title-bar-logo"]}href='/'>
                            <Image className={styles["logo"]}alt="logo" width={40} height={40}src="/home/scaled_cropped_logo2.jpg"/>
                    ...
                    <div className={styles["title-bar-element"]+" " +styles["sign-in-up"]} aria-hidden={width<1025?true:false}>
                        ...
                        <div className={styles["acc-stuff"]}>
                            ...
                            <Link className={router.pathname.includes("cart")?styles["acc-link"]+ " "+styles["active-link"]:styles["acc-link"]} href="/cart" passHref replace><span id="cart" className={styles["cart-writing"]}>{`You have ${context.state.totalQuantity} item${context.state.totalQuantity===1?'' :'s'} in your basket.`}</span></Link>
                        </div>
                    </div>
                ...
                <ul className={`${styles["nav-list"]} ${mobileMenuOpen?"":styles["mobile-menu-visibility"]}`}>
                    ...
                    <li className={router.pathname.includes("wholesale")?styles["nav-element"]+" "+styles["active-link-pri"]:styles["nav-element"]}><Link href="/wholesale" onClick={()=>menuOpen()}><span>Wholesale</span></Link></li>
                    <li className={router.pathname.includes("about")?styles["nav-element"]+" "+styles["active-link-pri"]:styles["nav-element"]}><Link href="/about"onClick={()=>menuOpen()}><span>About us</span></Link></li>
                    <li className={router.pathname.includes("what-we-grow")?styles["nav-element"]+" "+styles["active-link-pri"]:styles["nav-element"]}><Link href="/what-we-grow"onClick={()=>menuOpen()}><span>What we grow</span></Link></li>
                    <li className={router.pathname.includes("contact-us")?styles["nav-element"]+" "+styles["active-link-pri"]:styles["nav-element"]}><Link href="/contact-us"onClick={()=>menuOpen()}><span>Contact us</span></Link></li>
