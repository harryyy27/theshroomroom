            ...
            <ul className={homeStyles["card-wrapper"]}>
                <li className={homeStyles["card"]}>
                    ...
                    <div className={homeStyles["card-text-wrap"]}>
                        <h2 className="bullet-heading">Antioxidants</h2>
                        <p className="bullet-margin">Antioxidants render free radicals in your body harmless by neutralising their electropositivity. This means your cells will incur a lot less damage from free radicals as your body actively eliminates them.</p>
                    </div>
                ...
                <figure className={homeStyles["card-figure"]}>
                    ...
                    <div className={homeStyles["card-text-wrap"]}>
                        <h2 className="bullet-heading">Brain health</h2>
                ...
                <figure className={homeStyles["card-figure"]}>
                    ...
                    <div className={homeStyles["card-text-wrap"]}>
                        <h2 className="bullet-heading">Delicious!</h2>
