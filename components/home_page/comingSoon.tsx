    ...
    return(
        ...
        <section className={homeStyles["wholesale-container"]}>
            <div className={homeStyles["wholesale-wrapper"]}>
                <div className={homeStyles["right"]+ " " +homeStyles["text-section"]+ " " + homeStyles["shadow"]}>
                    <h1 style={{marginBottom:"1rem"}}className={homeStyles["hero-heading"]+" light"}>COMING SOON</h1>
                    <button id="wholesaleCta" className="cta"><Link id="wholeSaleCtaLink" href="/wholesale">Be notified of release</Link></button>
                </div>
