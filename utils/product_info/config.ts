const config:{[key:string]:{question:string,answer:string | string[] }[]} = {
   ...
   { 
    ...
    answer:["Do not use lion's mane if you are pregnant", "If you are using blood thinning medication, please consult a health care professional before using lion's mane","If you are showing signs of an allergic reaction, seek medical help immediately."] 
},
{
