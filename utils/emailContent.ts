...
export function orderString(order:any){
    return `
        <!-- Content -->
        <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; text-align:left; border-width: 1px; border-color:#ddd; border-style:solid;" width="700">
          <tbody>
            <tr>
              <td style="padding:30px;width:640px;background-color:#FFF;color:#000; font-size:36px; font-weight:normal;">Order Confirmation</td>
            </tr>
            <tr>
            <tr>
              ...
              <td style="padding:15px 30px;width:640px;background-color:#FFF;">
                  ...
                  <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px; text-align:left;" width="640">
                    <tbody>
                      ...
                      <tr>
                        <td style="width:640px;color:#000; font-size:24px; font-weight:normal;">Your order will be delivered to:</td>
                      </tr>
                    </tbody>
                  </table>
      
                  <table cellspacing="0" cellpadding="0" style="border-collapse:collapse; font-size:14px; text-align:left;" width="640">
                    <tbody>
                ...
                <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px; text-align:left;" width="640">
                  <tbody>
                    ...
                    <tr>
                      <td style="width:640px;color:#000; font-size:24px; font-weight:normal;">Delivery Address</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; color:#000;  font-size:14px; text-align:left;" width="640">
                  <!-- start items loop -->
                  <thead>
                    <tr>
                      <th scope="col" style="width:65px;"></th>
                      <th scope="col" style="color:#000; font-size:14px; text-align:left;">Item</th>
                      <th scope="col" style="width:40px; color:#000; font-size:14px; text-align:center;">Qty</th>
                      <th scope="col" style="width:100px; color:#000; font-size:14px; text-align:right;">Price</th>
                      <th scope="col" style="width:100px; color:#000; font-size:14px; text-align:right;">Status</th>
                    </tr>
                  </thead>
                  <tbody>
                        ...
                        order.products.items.map(({_id,name,quantity,price,fresh,size,stripeProductId}:Product,idx:number)=>{
                            return`
                                    ...
                                    <td class="image" style="text-align:left; padding:20px 10px 20px 0; vertical-align:top;">
                                        <a href="${process.env.WEBSITE_NAME}/products/${name.replace(/[\s]/gi,'-')}"><img src="${process.env.WEBSITE_NAME}/${imageMap[name].path}.${imageMap[name].fileType}" alt="DIANA" border="0" style="max-width: 100%;"></a>
                                    </td>
                ...
                <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px; text-align:left;" width="640">
                  <tbody>
                    ...
                    <tr>
                      <td style="width:640px; color:#000; font-size:24px; font-weight:normal;">Order Summary</td>
                    </tr>
                  </tbody>
                </table>
      
                <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; color:#000;  font-size:14px; text-align:left;" width="700">
                  <!-- start totals -->
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <th style="width:320px; color:#fff; text-align:left; font-weight:bold;  padding:15px 0;">Total</th>
                      <td style="width:320px; color:#fff; padding:15px 0; text-align:right; font-weight:bold;">=£${order.shippingCost+order.products.items.reduce((acc:number,el:any)=>acc+el.price,0)}</td>
                    </tr>
                  </tbody>
                  <!-- end totals -->
                </table>
...
export function receiveUpdateString(user:any,email:string){
    ...
    <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; text-align:left; border-width: 1px; border-color:#ddd; border-style:solid;" width="700">
      <tbody>
        <tr>
          <td style="padding:30px;width:640px;background-color:#FFF;color:#000; font-size:36px; font-weight:normal;">Welcome to Mega Mushrooms!</td>
        </tr>
        <tr>
        <tr>
          <td style="padding:15px 30px;width:640px;background-color:#FFF;">
            ...
            <p style="margin:0;">In the mean time, you are welcome to browse our current range of <a href=\"${process.env.WEBSITE_NAME}/products\">products</a></p>
            
            <p style="margin:0;">No longer wish to receive emails from Mega Mushrooms?</p><p><a href="${process.env.WEBSITE_NAME}/${user?"edit":`unsubscribe?email=${email}`}">Unsubscribe</a></p>
          </td>
        </tr>
    </tbody>
    </table>`
...
export function subscriptionString(subscription:any){
    return `
        ...
        <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; text-align:left; border-width: 1px; border-color:#ddd; border-style:solid;" width="700">
          <tbody>
            <tr>
              <td style="padding:30px;width:640px;background-color:#FFF;color:#000; font-size:36px; font-weight:normal;">Subscription Confirmation</td>
            </tr>
            <tr>
            <tr>
              <td style="padding:15px 30px;width:640px;background-color:#FFF;">
                <p>Dear ${subscription.firstName + " " + subscription.surname} </p>
                <p style="margin:0;">Thank you for placing starting a ${subscription.interval}ly subscription with Mega Mushrooms.</p>
                <p style="margin:0;">Your order number is ${subscription.subscriptionId}, placed ${subscription.dateOfPurchase}.</p>
              ...
              <td style="padding:15px 30px;width:640px;background-color:#FFF;">
                    ...
                    ${
                        subscription.products.items.map(({_id,name,quantity,price,fresh,size,stripeProductId}:Product,idx:number)=>{
                            return`
                                    <tr>
                                    <td class="image" style="text-align:left; padding:20px 10px 20px 0; vertical-align:top;">
                                        <a href="${process.env.WEBSITE_NAME}/products/${name.replace(/[\s]/gi,'-')}"><img src="${process.env.WEBSITE_NAME}/${imageMap[name].path}.${imageMap[name].fileType}" alt="${imageMap[name].alt}" border="0" style="max-width: 100%;"></a>
                                    </td>
                                    <td style="text-align:left; padding:20px 10px; vertical-align:top;">
                                    ${fresh?"Fresh ":"Dry "}${name}${` ${size}`}
                                        <!-- Variants -->
                ...
                <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-size:14px; text-align:left;" width="640">
                  <tbody>
                    ...
                    <tr>
                      <td style="width:640px; color:#000; font-size:24px; font-weight:normal;">Subscription Summary</td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; color:#000;  font-size:14px; text-align:left;" width="700">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <th style="width:320px; color:#fff; text-align:left; font-weight:bold;  padding:15px 0;">Total</th>
                      <td style="width:320px; color:#fff; padding:15px 0; text-align:right; font-weight:bold;">=£${subscription.shippingCost+subscription.products.items.reduce((acc:number,el:any)=>acc+el.price,0)}</td>
                    </tr>
                  </tbody>
                  <!-- end totals -->
                </table>
...
export function deleteAccountString(){
    ...
    <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; text-align:left; border-width: 1px; border-color:#ddd; border-style:solid;" width="700">
      <tbody>
        <tr>
          <td style="padding:30px;width:640px;background-color:#FFF;color:#000; font-size:36px; font-weight:normal;">We are sorry to see you go :(!</td>
        </tr>
        <tr>
        <tr>
          <td style="padding:15px 30px;width:640px;background-color:#FFF;">
            ...
            <p style="margin:0;">Despite the fact you no longer have an account with us, you are still welcome to purchase from or browse our current range of <a href=\"${process.env.WEBSITE_NAME}/products\">products</a>.</p>
...
export function registerString(user:any,email:string){
    ...
    <table cellpadding="0" cellspacing="0" style="border-collapse:collapse; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:14px; text-align:left; border-width: 1px; border-color:#ddd; border-style:solid;" width="700">
      <tbody>
        <tr>
          <td style="padding:30px;width:640px;background-color:#FFF;color:#000; font-size:36px; font-weight:normal;">Welcome to Mega Mushrooms ${user.name}!</td>
        </tr>
        <tr>
        <tr>
          <td style="padding:15px 30px;width:640px;background-color:#FFF;">
            ...
            <p style="margin:0;">${!user.updates?"Wish to receive updates of new products or services?":"No longer wish to receive updates of new products or servces?"} <a href="${process.env.WEBSITE_NAME}/edit">${!user.updates?"Subscribe":"Unsubscribe"}</a></p>
          </td>
        </tr>
    </tbody>
    </table>`
