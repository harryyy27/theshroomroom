        ...
        <div className="static-container">
                    ...
                    <h1 className="main-heading center">Cart</h1>
                        <div className="cart-summary">
                            <p><b>Sub-total: </b>{(!isSale?<span>£{String(Number(context.state.subTotal).toFixed(2))}</span>:<><span style={{textDecoration:"line-through"}}>£{String(Number(context.state.subTotal).toFixed(2))}</span><span style={{marginLeft:"0.25rem",color:"green",fontWeight:"700"}}>£{String((Number(context.state.subTotal)*0.9).toFixed(2))}</span></>)}</p>
