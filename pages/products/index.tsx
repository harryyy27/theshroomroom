                ...
                return(
                    <li className="product" key={idx}>
                        ...
                        </Link>
                        {
                            ...
                            <p className="product-price">{!isSale?<span>£{Number(price).toFixed(2)}</span>:<><span style={{textDecoration:"line-through"}}>£{Number(price).toFixed(2)}</span><span style={{marginLeft:"0.25rem",color:"green",fontWeight:"700"}}>£{Number(price*0.9).toFixed(2)}</span></>}</p>
